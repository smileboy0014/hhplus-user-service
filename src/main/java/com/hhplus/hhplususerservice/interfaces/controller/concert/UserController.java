package com.hhplus.hhplususerservice.interfaces.controller.concert;

import com.hhplus.hhplususerservice.domain.user.UserService;
import com.hhplus.hhplususerservice.interfaces.common.dto.ApiResultResponse;
import com.hhplus.hhplususerservice.interfaces.controller.concert.dto.UserBalanceDto;
import com.hhplus.hhplususerservice.support.aop.TraceLog;
...
public class UserController {
    ...
    public ApiResultResponse<UserBalanceDto.Response> getBalance(@PathVariable("userId") @NotNull(message = "유저 ID는 필수값 입니다.") Long userId) {
        ...
        return ApiResultResponse.ok(
                UserBalanceDto.Response.of(userService.getUser(userId)));
    }
    ...
    public ApiResultResponse<UserBalanceDto.Response> chargeBalance(@PathVariable("userId")
        ...
        return ApiResultResponse.ok(
                UserBalanceDto.Response.of(userService.chargeBalance(request.toCreateCommand(userId))));
