package com.hhplus.hhplususerservice.support.aop;
...
import static com.hhplus.hhplususerservice.domain.common.exception.ErrorCode.LOCK_ACQUIRE_FAILED;
...
public class DistributedLockAspect {
    ...
    @Around("@annotation(com.hhplus.hhplususerservice.support.aop.DistributedLock)")
